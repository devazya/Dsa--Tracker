...
export default function Dashboard({ user }) {
  ...
  onMouseEnter={e => { e.target.style.background = colors.orange; e.target.style.color = "#1a1a1a"; }}
  onMouseLeave={e => { e.target.style.background = colors.orangeDim; e.target.style.color = colors.orange; }}
  style={{
...
<button
  ...
  onMouseEnter={e => { e.target.style.background = "#ffb84d"; e.target.style.transform = "translateY(-1px)"; }}
  ...
  style={{
    ...
    fontWeight: "700", transition: "all 0.2s",
        ...
        {/* Problem List */}
        {loading ? (
          <div style={{ textAlign: "center", padding: "60px 0", color: colors.textMuted, fontSize: "13px" }}>
            Loading…
          </div>
        ) : filtered.length === 0 ? (
          <div style={{
      ...
      {showSettings && (
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <ol style={{ margin: 0, paddingLeft: "16px", display: "flex", flexDirection: "column", gap: "4px" }}>
                ...
                style={{
                  ...
                  fontSize: "12px", color: colors.orange,
            ...
            <div>
              <label style={{
                fontSize: "11px", color: colors.textMuted, display: "block",
